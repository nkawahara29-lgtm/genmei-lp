    ...
    <div className="min-h-screen bg-[#0d0c0a] text-[#e5e1da] font-sans selection:bg-amber-700/30 overflow-x-hidden">
      ...
      <nav className="fixed w-full z-[100] bg-[#0d0c0a]/95 backdrop-blur-md border-b border-[#3d3a33]">
        ...
        <div className={`fixed inset-y-0 right-0 w-[75%] bg-[#1a1814] z-[105] shadow-2xl transition-transform duration-300 md:hidden ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex flex-col p-10 pt-24 space-y-8 text-lg font-serif text-center">
            <a href="#about" onClick={() => setIsMenuOpen(false)} className="border-b border-white/5 pb-4 text-gray-200">占術と物語</a>
            <a href="#voice" onClick={() => setIsMenuOpen(false)} className="border-b border-white/5 pb-4 text-gray-200">読者の声</a>
            <a href="#faq" onClick={() => setIsMenuOpen(false)} className="border-b border-white/5 pb-4 text-gray-200">よくある質問</a>
            <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className="bg-[#06C755] text-white text-center font-bold py-4 rounded-full mt-4 text-base shadow-xl active:scale-95 transition">
              無料で相手の本音を知る
            </a>
          </div>
        </div>
      ...
      <section className="relative pt-32 pb-24 px-4 min-h-[95vh] flex items-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          {/* Card Selection Container - Improved Contrast */}
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            {[
              ...
              <div key={i} className="bg-[#0d0c0a] p-10 border border-amber-900/20 italic font-serif relative shadow-xl">
      ...
      <section id="faq" className="py-24 bg-[#0d0c0a]">
        <div className="max-w-3xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-[10px] tracking-[0.2em] text-gray-300 uppercase font-serif font-bold">Frequently Asked Questions</p>
          </div>
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="bg-white/[0.05] p-6 border border-white/10 rounded-sm shadow-sm group hover:border-amber-500/30 transition">
      ...
      {/* Final CTA Section - High Contrast LINE Theme */}
      <section id="price" className="py-28 px-4 text-center bg-gradient-to-b from-[#0d0c0a] to-[#1a1814]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-[#14120f] p-8 md:p-16 border border-amber-500/30 shadow-[0_30px_70px_rgba(0,0,0,0.8)] space-y-10 rounded-2xl relative overflow-hidden">
            ...
            <p className="text-gray-200 text-sm md:text-base font-serif leading-relaxed max-w-sm mx-auto italic relative z-10 text-shadow-sm">
      ...
      {/* Disclaimers & Evidence - High Contrast Improvement */}
      ...
      {/* Footer - High Contrast Improvement */}
      ...
      {/* Smart Floating Sticky Button - Optimized High Contrast LINE Theme */}
